                ...
                <div className="container-fluid text-center">
                    <div className="container-inner">
                        ...
                        <div className="custom-grid">
                            ...
                            <div className="award-card">
                                <div className="award-logo">
                                    <img width={214} height={32} src="/assets/enterpriseWorld.webp" className="award-logo wp-post-image" alt="The Enterprise World" decoding="async" />                    
                                </div>
                            </div>
                            ...
                            <div className="award-card">
                                <div className="award-logo">
                                    <img width={194} height={36} src="/assets/siliconIndia.webp" className="award-logo wp-post-image" alt="SiliconIndia" decoding="async" />                    
                                </div>
                            </div>
                            ...
                            <div className="award-card">
                                <div className="award-logo">
                                    <img width={194} height={36} src="/assets/techreviewer.webp" className="award-logo wp-post-image" alt="Techreviewer" decoding="async" />                    
                                </div>
                            </div>
