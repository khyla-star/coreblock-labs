...
import PhoneCountryInput from '../../shared/PhoneCountryInput';
import { COMPANY_EMAIL, COMPANY_LINKEDIN, COMPANY_TAGLINE } from '../../../data/company';
  ...
  return (
    <section className="contact-hero" id="contact-hero">
      <div className="container-fluid contact-hero-container">
        <div className="row g-4 contact-hero-row">
          <div className="col-lg-5">
            <div className="project-panel">
                ...
                {inquirySteps.map((step) => (
                  <li key={step}>
                    <i className="bi bi-check-circle-fill" aria-hidden="true">
                      <img src="/assets/icon-tick.svg" width={20} height={20} alt="" />
                    </i>
                    {step}
                  </li>
                ))}
              ...
              <div className="contact-info-inquiry">
                <p className="section-label">Project Inquiries</p>
              ...
              <div className="social-icons">
                <a
                  ...
                  aria-label="Telegram"
                >
                  <img src="/assets/icon-telegram.svg" width={19} height={19} alt="" />
                </a>
                <a
                  ...
                  aria-label="LinkedIn"
                >
                  <img src="/assets/linkedin.svg" width={19} height={19} alt="" />
                </a>
                <a href={`mailto:${COMPANY_EMAIL}`} className="social-email" aria-label="Email">
                  <img src="/assets/icon-email.svg" width={19} height={19} alt="" />
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-7">
            <div className="form-panel">
              <div className="form-panel-header">
                ...
                <div className="alert d-none contact-form-alert" id="contact_form_status_top" role="alert" />
              </div>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      name="email"
                      className="form-control"
                      placeholder="hello@coreblocklabs.com"
                    />
                  ...
                  <div className="col-12">
                    ...
                    <PhoneCountryInput idPrefix="contactPage" phoneInputId="contactPagePhone" />
