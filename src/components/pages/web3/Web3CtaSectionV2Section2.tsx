...
export default function Web3CtaSectionV2Section2() {
  return (
    <>
          ...
          <div className="container">
              <div className="d-flex gap-4 align-items-center justify-content-between flex-lg-nowrap flex-wrap">
                  ...
                  <div className="cta-content">
                              ...
                              Ready to Build a Truly Decentralized Web3 Platform?                    </h2>
                      
                                          <p className="text-white-70 mb-0">
                              Connect with our Web3 development experts to design secure, and user-owned decentralized solutions customized for your business.                    </p>
